...
[comment]: <> (Balloted Changes for IHE ITI TF [CP-ITI-1321-02](https://docs.google.com/document/d/1_akpDRB5dXZands28SUM7suXdTGaCBwQ/edit?tab=t.0#heading=h.5t0km02n25aj), see also [PR](https://github.com/IHE/publications/pull/575/commits/5af691e7f8c7c91e51ceb2971e88da85f1783314))

## IHE IT Infrastructure (ITI) Technical Framework Volume 1

|------------------------------------------------|
| Editor: Apply the following updates to [Section 18.2.3](https://profiles.ihe.net/ITI/TF/Volume1/ch-18.html#18.2.3) Grouping Rules by the following: |
{:.grid .bg-info}
...
**<u>Grouping with a MHD Document Consumer is used in situations where a Responding Gateway belongs to a community with an MHD Document Responder.</u>**

**<u>When a Responding Gateway belongs to an MHDS community, it may resolve Cross Gateway Query and Cross Gateway Retrieve transactions by grouping with an MHD Document Consumer and using the Find Document Lists, Find Document References and Retrieve Document transactions. For details see Section 18.2.3.3</u>**

**<u>A Responding Gateway MAY use non-IHE interactions to collect local information in response to a Cross Gateway Query or Cross Gateway Retrieve. These proprietary interactions are not further described within any IHE profile.</u>**


|------------------------------------------------|
| Editor: Apply the following updates to [Section 18.2.3.2](https://profiles.ihe.net/ITI/TF/Volume1/ch-18.html#18.2.3.2) Responding Gateway grouped with XDS Document Consumer with the following: |
{:.grid .bg-info}
...
|------------------------------------------------|
| Editor: Apply the following updates to [Section 27.2](https://profiles.ihe.net/ITI/TF/Volume1/ch-27.html#27.2) XCPD Actor Options with the following: |
{:.grid .bg-info}
...
|  | **<u>MHDS Federation Option</u>** | **<u>ITI TF-1: 27.2.3</u>** |
...
## IHE IT Infrastructure (ITI) Technical Framework Volume 2

|------------------------------------------------|
| Editor: Add section [3.38.4.1.3.3](https://profiles.ihe.net/ITI/TF/Volume2/ITI-38.html) MHD Grouping Considerations with the following: |
{:.grid .bg-info}

### **3.38.4.1.3.3 MHD Grouping Considerations**
